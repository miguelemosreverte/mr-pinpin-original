# Title miniature — Home, Sweet Home

Approved by Miguel. Shared text-free 1024 × 1536 master, displayed at different sizes without generating separate artwork. Copied byte-for-byte from `../textless-v1.png`.
