...
Estimated outward view-space surface normals from smoothed artistic depth; not ground-truth geometry or world-space orientation.

RGB8 UNORM: normalize(2 * rgb / 255 - 1). No sRGB transfer. +X right, +Y up, +Z toward viewer; right-handed camera space.
