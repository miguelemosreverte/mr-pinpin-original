...
## Later user-reported bathtub boundary

The user subsequently found a broken wooden side and metal band at the bathroom down-repair boundary, most visible at yaw 1.9 / pitch −0.5 radians. The prior sampled views did not establish continuity across every object boundary. Layer isolation confirmed the downward repair was crossing a conflicting tub silhouette. The [bathroom boundary correction](../house-bath-join-20260924/README.md) limits that repair to the floor side and preserves the tub from the underlying image. Its before/after and focused regression checks supersede any broad inference of seamlessness from this earlier review.
