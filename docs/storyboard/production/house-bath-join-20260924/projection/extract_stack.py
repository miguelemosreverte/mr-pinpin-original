...
def main():
 ...
 modes={'current-stack-before':['front','rear','down'],'base-only-before':[],'down-only-before':['down'],'without-down-before':['front','rear']}
