...
The subsequent [common-room style experiment](../../../house-style-review.html) compares one additional appearance pass against this tour and an actual book illustration. It is separate from the selected three-room tour.
