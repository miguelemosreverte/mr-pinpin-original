(() => {
  'use strict';
  const text = {
    ru: {title:'Дом Мистера Пин-Пина',door:'Открыть дверь в лес',bookcase:'Открыть книжный шкаф',scene:'Уютная комната Мистера Пин-Пина: дверь в лес слева и книжный шкаф справа.',choose:'Выберите дверь или книжный шкаф',skip:'Перейти к комнате'},
    en: {title:'Mr. PinPin’s House',door:'Open the door to the forest',bookcase:'Open the bookcase',scene:'Mr. PinPin’s cozy room, with a forest door on the left and a bookcase on the right.',choose:'Choose the door or bookcase',skip:'Go to the room'},
    es: {title:'La casa del señor PinPin',door:'Abrir la puerta al bosque',bookcase:'Abrir la biblioteca',scene:'La acogedora habitación del señor PinPin, con una puerta al bosque a la izquierda y una biblioteca a la derecha.',choose:'Elige la puerta o la biblioteca',skip:'Ir a la habitación'}
  };
