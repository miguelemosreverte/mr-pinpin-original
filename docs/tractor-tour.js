...
import {tourGestures} from './tractor-tour-gestures.js?v=tour-looping-v1';
...
const gestures=tourGestures(stage,{progress,orbit,isLooking:()=>mode==='look',startLook:look,cancelInput:()=>{deferredLook=null;resetLookInput();},drag:(dx,dy)=>head(-dx/stage.clientHeight*camera.fov*RAD,dy/stage.clientHeight*camera.fov*RAD),wheelInput,zoom:delta=>head(0,0,delta)},{captureButton:$('capture'),captureHint:$('capture-help')});
